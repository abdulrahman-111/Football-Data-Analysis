...
class SettingsPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.current_accent = ACCENT_CYAN
    ...
    def _build_ui(self):
        ...
        self.anim_check.setFont(QFont("Segoe UI", 10))

        self.anim_check.setStyleSheet("""
            color: white;
        """)

        ag.addWidget(self.anim_check)
        ...
        for name, fname in model_files:
            ...
            status_lbl.setStyleSheet(f"""
                background: transparent;
                color: {'#00FF88' if exists else '#FF3B5C'};
            """)
    ...
    def change_theme(self, theme_name):
        ...
        if "Cyan" in theme_name:
            accent = "#00BCD4"

        elif "Green" in theme_name:
            accent = "#00C853"

        elif "Gold" in theme_name:
            accent = "#FFD600"
        ...
        # Apply ONLY small targeted styles
        ...
        self.notify.emit(
            f"{theme_name} theme applied successfully",
            "success"
        )